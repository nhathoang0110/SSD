...
from utils.augmentation import Compose, ConvertFromInts, ConvertColor, \
    ToAbsoluteCoords, PhotometricDistort, Expand, RandomSampleCrop,RandomMirror, \
...
if __name__ == '__main__':
    ...
    anno_info = trans_anno(train_annotation_list[0],width,height)
    ...
    #transform img
    phase="train"
    img_transformed, boxes, labels = transform(img, phase, anno_info[:,:4],anno_info[:,4])
